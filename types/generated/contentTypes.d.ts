...
export interface ApiBoardPersonBoardPerson extends Struct.CollectionTypeSchema {
  collectionName: 'board_people';
  info: {
    description: '';
    displayName: 'BoardPerson';
    pluralName: 'board-people';
    singularName: 'board-person';
  };
  options: {
...
export interface ApiGaleryGalery extends Struct.CollectionTypeSchema {
...
export interface ApiHomeArticleHomeArticle extends Struct.CollectionTypeSchema {
...
export interface ApiProgramProgram extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    forAll: Schema.Attribute.Boolean;
    forJunior: Schema.Attribute.Boolean;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::program.program'
